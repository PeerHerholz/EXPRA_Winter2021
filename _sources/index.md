...
<img align="right" src="https://raw.githubusercontent.com/PeerHerholz/EXPRA_Winter2021/master/lecture/static/undraw_Processing_re_tbdu_expra.png" alt="logo" title="logo" width="600" height="300" />
...
Hello everyone and welcome to the course page for "EXPRA - group 3", taught
within the [Psychology bachelor programme](https://www.goethe-university-frankfurt.de/51789866/Institute_of_Psychology?) of the [Goethe-University Frankfurt](https://www.goethe-university-frankfurt.de/en) during the winter term 2021. We're glad to see you here!
...
* [Overview & procedure ](https://peerherholz.github.io/EXPRA_Winter2021/overview.html)

   What's this course all about? How are things implemented and supposed to work? 

* [General outline](https://peerherholz.github.io/EXPRA_Winter2021/outline.html)

   What are the specific topics and aspects taught?

* [Course setup](https://peerherholz.github.io/EXPRA_Winter2021/setup.html)

   What do I need to follow and participate in the course?

* [An introduction to the scientific method & theory building](https://peerherholz.github.io/EXPRA_Winter2021/introduction/introduction.html)

   All things gotta start somewhere and working on a research project is no exception to
   that, but how?

* [Experimentation](https://peerherholz.github.io/EXPRA_Winter2021/experimentation/experimentation.html)

   How to set up and conduct experiments to acquire data from participants and subsequently analyze it? 

* [Project finalization](https://peerherholz.github.io/EXPRA_Winter2021/finalization/finalization.html)

   How can you successfully generate insights from your obtained results and communicate those sufficiently? 

* [Student projects](https://peerherholz.github.io/EXPRA_Winter2021/projects.html)

   Making sure the work and progress of the participants is transparent and
   documented.

* [Questionnaires](https://peerherholz.github.io/EXPRA_Winter2021/questionnaires.html)

   Was it worth it and how can this be evaluated?

* [Code of Conduct](https://peerherholz.github.io/EXPRA_Winter2021/CoC.html)
...
In case you have any questions or difficulties with the lecture and its materials, please don’t hesitate a single second to get in touch. A great way to do this is to [open an issue](https://github.com/PeerHerholz/EXPRA_Winter2021/issues) on the
